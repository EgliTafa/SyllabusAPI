...
{
    /// <summary>
    /// Example request for updating course details.
    /// </summary>
    public class UpdateCourseDetailRequestExample
    {
        /// <summary>
        /// Gets an example request for updating course details.
        /// </summary>
        public static CourseDetailRequestApiDTO Example => new()
        {
            ...
            Topics = new()
            {
                ...
                new()
                {
                    ...
                    Hours = 4,
                    Reference = "Cisco Security Documentation"
                }
            }
        };
    }
