        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserEntity_PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SylabusId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Courses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Courses_Syllabuses_SylabusId",
                        column: x => x.SylabusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_PhonePrefix_PhoneNumber",
                table: "Users",
                columns: new[] { "PhonePrefix", "PhoneNumber" },
                unique: true,
